  ...
  return (
    ...
    >
      ...
      <div className="flex-1 w-full relative">
        ...
        <div className="w-full lg:w-[40%] flex flex-col justify-center px-8 md:px-12 py-20 lg:py-0 min-h-[85vh] lg:min-h-[calc(100vh-40px)] lg:border-r border-brand-border/40 relative z-20 bg-transparent lg:backdrop-blur-[6px] lg:bg-[#0a0a0a]/50 pointer-events-none lg:pointer-events-auto">
        ...
        <div className="absolute inset-0 lg:left-auto lg:right-0 lg:top-0 lg:bottom-0 w-full lg:w-[60%] overflow-hidden z-0 lg:z-10">
          ...
          <div className="absolute inset-0 flex items-center justify-center pointer-events-auto z-0 lg:z-10">
            <Suspense fallback={null}>
              <Spline
                scene="https://prod.spline.design/Fm-tD6aRlFY63N5H/scene.splinecode"
                className="w-full h-full relative z-10 scale-[1.2] lg:scale-[1.15]"
                onLoad={handleLoad}
              />
            </Suspense>
          </div>
